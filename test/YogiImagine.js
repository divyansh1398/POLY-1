...
describe("YogiImagineNFT", function () {
  ...
  beforeEach(async function () {
    ...
    // Deploy contract
    const YogiImagineNFT = await ethers.getContractFactory("YogiImagine");
    contract = await YogiImagineNFT.deploy();
    await contract.deployed();
  });

  // Test that the prompt description is set correctly
  it("should set the correct prompt description", async function () {
    expect(await contract.promptDescription()).to.equal("Yogi Imagine NFTs");
  });
